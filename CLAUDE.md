...
- 17 VOCs done: Angle Grinder, Arc Welding, Bandsaw, Guillotine, Overhead
  Crane, Storage & Handling of Steel in Warehouse Racking, Blower, Brake
  ...
  (Yandina), Use of Air Compressor and Pneumatic Tools. 12 of those were
  built from Word docs in `VOC Content for
